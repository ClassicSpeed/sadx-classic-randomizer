...
public:
    ...
    void SetCharacterVoiceReactions(bool eggmanCommentOnTrap, bool otherCharactersCommentOnTrap, bool currentCharacterReactToTrap, bool showCommentsSubtitles);
