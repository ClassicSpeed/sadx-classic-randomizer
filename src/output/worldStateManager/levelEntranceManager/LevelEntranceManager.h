...
class LevelEntranceManager
{
public:
    static LevelEntranceManager& Init(Options& options, Settings& settings, GameStatus& gameStatus)
    {
        if (_instance == nullptr)
            _instance = new LevelEntranceManager(options, settings, gameStatus);
        return *_instance;
    }
...
private:
    explicit LevelEntranceManager(Options& options, Settings& settings, GameStatus& gameStatus);
    inline static LevelEntranceManager* _instance = nullptr;
    Options& _options;
    Settings& _settings;
