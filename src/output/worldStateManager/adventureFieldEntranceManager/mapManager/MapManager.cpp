...
NJS_TEXANIM* MapManager::getFullNameFromEntrance(LevelAndActIDs levelAndAct, EntranceId entranceId)
{
    ...
    case LevelAndActIDs_EmeraldCoast3:
        return emerald_coast_full_map_anim;
    case LevelAndActIDs_WindyValley1:
    case LevelAndActIDs_WindyValley2:
    case LevelAndActIDs_WindyValley3:
        return windy_valley_full_map_anim;
    case LevelAndActIDs_TwinklePark1:
    case LevelAndActIDs_TwinklePark2:
    case LevelAndActIDs_TwinklePark3:
        return twinkle_park_full_map_anim;
    case LevelAndActIDs_SpeedHighway1:
    case LevelAndActIDs_SpeedHighway2:
    case LevelAndActIDs_SpeedHighway3:
        return speed_highway_full_map_anim;
    case LevelAndActIDs_RedMountain1:
    case LevelAndActIDs_RedMountain2:
    case LevelAndActIDs_RedMountain3:
        return red_mountain_full_map_anim;
    case LevelAndActIDs_SkyDeck1:
    case LevelAndActIDs_SkyDeck2:
    case LevelAndActIDs_SkyDeck3:
        return sky_deck_full_map_anim;
    case LevelAndActIDs_LostWorld1:
    case LevelAndActIDs_LostWorld2:
    case LevelAndActIDs_LostWorld3:
        return lost_world_full_map_anim;
    case LevelAndActIDs_IceCap1:
    case LevelAndActIDs_IceCap2:
    case LevelAndActIDs_IceCap3:
    case LevelAndActIDs_IceCap4:
        return ice_cap_full_map_anim;
    case LevelAndActIDs_Casinopolis1:
    case LevelAndActIDs_Casinopolis2:
    case LevelAndActIDs_Casinopolis3:
    case LevelAndActIDs_Casinopolis4:
        return casinopolis_full_map_anim;
    case LevelAndActIDs_FinalEgg1:
    case LevelAndActIDs_FinalEgg2:
    case LevelAndActIDs_FinalEgg3:
        return final_egg_full_map_anim;
    case LevelAndActIDs_HotShelter1:
    case LevelAndActIDs_HotShelter2:
    case LevelAndActIDs_HotShelter3:
    case LevelAndActIDs_HotShelter4:
        return hot_shelter_full_map_anim;
    case LevelAndActIDs_Chaos0:
        return chaos_0_full_map_anim;
    case LevelAndActIDs_Chaos2:
        return chaos_2_full_map_anim;
    case LevelAndActIDs_Chaos4:
        return chaos_4_full_map_anim;
    case LevelAndActIDs_Chaos6Sonic:
    case LevelAndActIDs_Chaos6Knuckles:
        return chaos_6_full_map_anim;
    case LevelAndActIDs_EggHornet:
        return egg_hornet_full_map_anim;
    case LevelAndActIDs_EggWalker:
        return egg_walker_full_map_anim;
    case LevelAndActIDs_EggViper:
        return egg_viper_full_map_anim;
    case LevelAndActIDs_Zero:
        return zero_full_map_anim;
    case LevelAndActIDs_E101:
        return beta_full_map_anim;
    case LevelAndActIDs_E101R:
        return beta_mk2_full_map_anim;
    case LevelAndActIDs_TwinkleCircuit1:
    case LevelAndActIDs_TwinkleCircuit2:
    case LevelAndActIDs_TwinkleCircuit3:
    case LevelAndActIDs_TwinkleCircuit4:
    case LevelAndActIDs_TwinkleCircuit5:
    case LevelAndActIDs_TwinkleCircuit6:
        return twinkle_circuit_full_map_anim;
    case LevelAndActIDs_SkyChase1:
        return sky_chase_1_full_map_anim;
    case LevelAndActIDs_SkyChase2:
        return sky_chase_2_full_map_anim;
    case LevelAndActIDs_SandHill:
        return sand_hill_full_map_anim;
    case LevelAndActIDs_SSGarden:
    case LevelAndActIDs_ECGarden:
    case LevelAndActIDs_MRGarden:
        return chao_garden_full_map_anim;
    default:
        // return nullptr;
        return question_mark_anim;
    }
