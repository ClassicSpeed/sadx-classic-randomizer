...
void ReactionManager::PlayRandomVoiceForItem(const ItemData& item, const int64_t itemId) const
{
    ...
    {
        if (_options._currentCharacterCommentOnCharacterUnlock)
        {
        ...
        if (itemId == 4)
        {
            if (_options._unlockedCharacterCommentOnCharacterUnlock)
            {
        ...
        else if (itemId == 5)
        {
            ...
            if (_options._eggmanCommentOnCharacterUnlock)
            {
    ...
    {
        if (_options._currentCharacterCommentOnKeyItems)
        {
        ...
        if (_options._eggmanCommentOnKeyItems)
        {
        ...
        if (_options._tikalCommentOnKeyItems)
        {
    ...
    if (!selector.isEmpty())
    {
        ...
        PlayVoice(voice);
        if (_options._showCommentsSubtitles)
        {
...
void ReactionManager::PlayRandomTrapVoice(const FillerType filler)
{
    ...
    if (_options._eggmanCommentOnTrap)
    {
    ...
    if (_options._otherCharactersCommentOnTrap)
    {
        if (CurrentCharacter != Characters_Amy)
        {
    ...
    if (_options._currentCharacterReactToTrap)
    {
        if (CurrentCharacter == Characters_Amy)
        {
