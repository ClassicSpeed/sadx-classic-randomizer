...
ItemRepository::ItemRepository(GameStatus& gameStatus) : _gameStatus(gameStatus)
{
    _itemData = {
        ...
        {77, ItemData::FillerItem("Checkpoint", Checkpoint)},
        {78, ItemData::FillerItem("Bomb", Bomb)},
        {79, ItemData::FillerItem("Extra 10 Seconds", Extra10Seconds)},
        ...
        {107, ItemData::FillerItem("Snowboard Trap", SnowboardTrap)},
        {108, ItemData::FillerItem("Spike Ball Trap", SpikeBallTrap)},
        {109, ItemData::FillerItem("Cart Trap", CartTrap)},
        {110, ItemData::FillerItem("Burger Man Trap", BurgerManTrap)},
        {111, ItemData::FillerItem("Walk Through Walls Trap", WalkThroughWallsTrap)},
...
std::map<std::string, FillerType> itemNameToFillerId = {
    ...
    {"Snowboard Trap", SnowboardTrap},
    {"Spike Ball Trap", SpikeBallTrap},
    {"Cart Trap", CartTrap},
    {"Burger Man Trap", BurgerManTrap},
    {"Walk Through Walls Trap", WalkThroughWallsTrap},
    {"Upside Down Trap", UpsideDownTrap},
    {"Mirror Trap", MirrorTrap},
    {"Decouple Camera Trap", DecoupleCameraTrap},
    //Extra
    ...
    {"Freeze Trap", IceTrap},
    {"Frozen Trap", IceTrap},
    {"Get Out Trap", SpringTrap},
    {"Ice Floor Trap", IceTrap},
    {"Inverted Mouse Trap", ReverseTrap},
    {"Paralyze Trap", IceTrap},
    {"Paralysis Trap", IceTrap},
    {"Reversal Trap", ReverseTrap},
    {"Reverse Controls Trap", ReverseTrap},
