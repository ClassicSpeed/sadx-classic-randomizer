...
private:
    ...
    std::map<int, std::string> _commentMap = {
        ...
        {579, "Hey there; Knuckles. Glad you finally made it! I thought you got lost or something."},
        ...
        {450, "His strength increases every time I feed him a Chaos Emerald!"},
        ...
        {1868, "The Egg Carrier has crashed and is floating somewhere in the ocean. Use this boat to get to it."},
        ...
        {1561, "You can get into a certain building using the Employee Card."},
        ...
        {1634, "The trolley car seems to be working. It leads to the jungle."},
        ...
        {1639, "If you have the Stone of Wind; gusts of strong wind are known to blow in the caves."},
        {510, "Let's go!"},
        {995, "I'm so happy!"},
        {1731, "Alright!"},
        {1732, "Yay!"},
